...
class Stock(ODYMBaseClass): # Flow needs to at least have dimension time x element
    ...
    def __init__(self, Name = None, ID = None, UUID = None, P_Res: int = None, Indices: str = None, Type: int = None, Values: np.ndarray=None, Uncert=None, Unit: str = None, Color: str = None):
