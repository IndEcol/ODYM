...
Mylog.info('Current Path: ' + ProjectSpecs_Path_Main)
...
class_filename = 'ODYM_Classifications_Master_' + str(ScriptConfig['Version of master classification']) + '.xlsx'
Classfile = xlrd.open_workbook(os.path.join(ProjectSpecs_Path_Main, class_filename))
